...
from tools.linkingTool import fetch_entity_context, link_elements
...
class TestPersonalDataTool:
    ...
    def test_update_person_data_partial_update(self, clean_test_data):
        ...
        update_person_data.invoke({"name": "Test Person Beta", "age": 25, "email": "beta@test.com"})

        # Update only age
        result = update_person_data.invoke({"name": "Test Person Beta", "age": 26})
    ...
    def test_fetch_person_data_existing(self, clean_test_data):
        ...
        # Create person first
        update_person_data.invoke({"name": "Test Person Gamma", "age": 35, "email": "gamma@test.com"})
    ...
    def test_fetch_person_data_case_insensitive(self, clean_test_data):
        ...
        update_person_data.invoke({"name": "Test Person Delta", "age": 40})
    ...
    def test_fetch_person_data_normalized_matching(self, clean_test_data):
        ...
        update_person_data.invoke({"name": "Test Person Épsilon", "age": 28})
...
class TestCrossToolIntegration:
    ...
    def test_complete_workflow_create_link_fetch(self, clean_test_data):
        ...
        update_person_data.invoke({"name": "Test Person Alice", "age": 28, "email": "alice@test.com"})
        update_person_data.invoke({"name": "Test Person Bob", "age": 32, "email": "bob@test.com"})
        ...
        context = fetch_entity_context.invoke({"name": "Test Person Alice", "type": "Person", "depth": 1})
        ...
        bob_context = fetch_entity_context.invoke({"name": "Test Person Bob", "type": "Person", "depth": 1})
...
class TestLinkingTool:
    ...
    def test_link_elements_create_relationship(self, clean_test_data):
        ...
        context = fetch_entity_context.invoke({"name": "Test Person Link1", "type": "Person", "depth": 1})
        context_data = json.loads(context)
    ...
    def test_fetch_entity_context_depth_1(self, clean_test_data):
        ...
        result = fetch_entity_context.invoke({"name": "Test Person Context1", "type": "Person", "depth": 1})
    ...
    def test_fetch_entity_context_depth_2(self, clean_test_data):
        ...
        result = fetch_entity_context.invoke({"name": "Test Person Context1", "type": "Person", "depth": 2})
    ...
    def test_fetch_entity_context_no_relations(self, clean_test_data):
        ...
        result = fetch_entity_context.invoke({"name": "Test Person Isolated", "type": "Person", "depth": 1})
    ...
    def test_fetch_entity_context_invalid_entity(self, clean_test_data):
        ...
        result = fetch_entity_context.invoke({"name": "Test Nonexistent Entity XYZ", "type": "Person", "depth": 1})
